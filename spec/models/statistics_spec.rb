...
describe Statistics do
  ...
  describe '#total_issues' do
    it 'returns count of all issues' do
      ...
      FactoryGirl.create(:published_issue)
  ...
  describe '#total_smts' do
    it 'returns count of all SMTs' do
      FactoryGirl.create(:issue_with_smts, smts_count: 1, fake_smts: 2, published: true)
  ...
  describe '#last_week_issues_count' do
    it 'returns all issues created in last 7 days' do
      FactoryGirl.create(:published_issue, created_at: 8.days.ago)
      FactoryGirl.create(:published_issue)
  ...
  describe '#top_issue_by_smts' do
    it 'returns issue with the highest SMTs count' do
      FactoryGirl.create(:issue_with_smts, smts_count: 1, fake_smts: 1, published: true)
      top = FactoryGirl.create(:issue_with_smts, smts_count: 1, fake_smts: 2, published: true)
  ...
  describe '#last_week_top_issue_by_smts' do
    it 'returns issue with the highest SMTs count from last 7 days' do
      FactoryGirl.create(:issue_with_smts, smts_count: 1, published: true)
      top = FactoryGirl.create(:issue_with_smts, smts_count: 2, published: true)
      old_top = FactoryGirl.create(:published_issue, created_at: 8.days.ago)
  ...
  describe '#lowest_issue_by_smts' do
    it 'returns oldest issue with smallest SMTs count' do
      FactoryGirl.create(:published_issue, fake_smts: 1, created_at: 2.days.ago)
      lowest = FactoryGirl.create(:issue_with_smts, smts_count: 1, created_at: 3.days.ago, published: true)
